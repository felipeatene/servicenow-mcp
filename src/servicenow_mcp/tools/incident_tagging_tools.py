...
_STOPWORDS = {
    ...
    "tag",
    "tags",
    # English stopwords for mixed-language incident descriptions
    "the",
    "and",
    "for",
    "with",
...
_KEYWORD_TAG_MAP = {
    ...
    "access": "acesso-autenticacao",
    "authentication": "acesso-autenticacao",
    "auth": "acesso-autenticacao",
    "password": "acesso-autenticacao",
    "signin": "acesso-autenticacao",
    "sign-in": "acesso-autenticacao",
    "risk": "fraude-risco",
    "fraud": "fraude-risco",
    "fraude": "fraude-risco",
    ...
    "failure": "falha-aplicacao",
    "error": "falha-aplicacao",
    "outage": "falha-aplicacao",
    "api": "api-integracao",
    "endpoint": "api-integracao",
    "timeout": "api-integracao",
    "latencia": "api-integracao",
    "latência": "api-integracao",
    "latency": "api-integracao",
    "integration": "api-integracao",
    ...
    "staging": "ambiente-homologacao",
    "qa": "ambiente-homologacao",
    ...
    "data": "dados-integridade",
    "duplicate": "dados-integridade",
    "inconsistent": "dados-integridade",
    "workflow": "fluxo-processo",
    "aprovação": "fluxo-processo",
    "aprovacao": "fluxo-processo",
    "approval": "fluxo-processo",
    "process": "fluxo-processo",
...
def _tokenize(text: str) -> List[str]:
    ...
    return [p for p in pieces if p not in _STOPWORDS and not p.isdigit()]
